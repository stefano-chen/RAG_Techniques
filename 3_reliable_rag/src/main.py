...
# check what out doc looklike
print(f"Title: {docs[0].metadata["title"]}\n\nSource: {docs[0].metadata['source']}\n\nContent: {docs[0].page_content}\n")

# check document relevancy using an llm
...
for doc in docs:
    ...
    print(res, "\n")
    if res.binary_score == "yes": # type: ignore
...
class GradeHallucinations(BaseModel):
    ...
    binary_score: str = Field(
        ...,
        description="Answer is grounded in the facts, 'yer' or 'no'"
    )
...
class HighlightDocuments(BaseModel):
    ...
    segment: List[str] = Field(
        ...,
        description="List of direct segments from used documents that answers the question"
    )
